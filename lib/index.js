...
AC.prototype.check = function(opt) {
    ...
    return function checkit(req, res, next) {
        ...
        var token = getAuthHeader(req) || req[self.options.tokenName] || req.body[self.options.tokenName] || req.query[self.options.tokenName] || req.cookies[self.options.tokenName] ;
